...
public class EmergencyMessages extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_emergency_mesaj, container, false);
        recyclerView = view.findViewById(R.id.recycler_emergencymesaj);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));

        bos_list = view.findViewById(R.id.empty_list_EmergencyMesaj);
