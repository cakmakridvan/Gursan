...
public class FlagMessages extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_flag_mesaj, container, false);
        recyclerView = view.findViewById(R.id.recycler_flagmesaj);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));

        bos_list = view.findViewById(R.id.empty_list_flagMesaj);
        ...
        todoListTask = new TodoListTask(Integer.parseInt(get_userID),Integer.parseInt(get_projectID),Integer.parseInt(get_userTypeID), Enums.msj_kapali);
        ...
        protected void onPostExecute(Boolean aBoolean) {
            ...
            if(!get_mesaj_todoList.equals("false")){
                ...
                if(todoList.size() > 0){
                    ...
                    adapter = new ListItemAdapter(listItems,getActivity(),Enums.msj_kapali);
                    //for SearchView in RecyclerView
                    adap = new ListItemAdapter(listItems,getActivity(),Enums.msj_kapali);
