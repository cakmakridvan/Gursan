...
// Depends on your web service
    ...
    public static String GetBuilding(Integer territoryID) {
        ...
        DefaultHttpClient httpclient = new DefaultHttpClient(new BasicHttpParams());
        HttpGet httppost = new HttpGet(Main_URL + method_Projects + "?" + "TerritoryId=" + territoryID);
// Depends on your web service
        httppost.setHeader("Content-type", "application/json");
    ...
    public static String GetArea(Integer buildingID) {
        ...
        DefaultHttpClient httpclient = new DefaultHttpClient(new BasicHttpParams());
        HttpGet httppost = new HttpGet(Main_URL + method_Projects + "?" + "BuildingId=" + buildingID);
// Depends on your web service
        httppost.setHeader("Content-type", "application/json");
    ...
    public static String GetDevice(Integer areaID) {
        ...
        DefaultHttpClient httpclient = new DefaultHttpClient(new BasicHttpParams());
        HttpGet httppost = new HttpGet(Main_URL + method_Projects + "?" + "AreaId=" + areaID);
// Depends on your web service
        httppost.setHeader("Content-type", "application/json");
...
// Depends on your web service
    ...
    public static String DocumentAdd(Integer workOrderID, Integer documentTypeID, Boolean active, String documentContent, String commentText, Integer insertUserID,
        ...
        try {
            ...
            jsonObject.put("UserID", insertUserID);
...
// Depends on your web service
    ...
    public static String GetByWorkOrder(Integer workOrder_id){

        String method_Projects = "DocumentService/GetByWorkOrder";
...
// Depends on your web service
    ...
    public static String CommentService(Integer workOrder_id){
        ...
        DefaultHttpClient httpclient = new DefaultHttpClient(new BasicHttpParams());
        HttpGet httppost = new HttpGet(Main_URL + method_Projects + "?" + "taskID=" + workOrder_id);
// Depends on your web service
        httppost.setHeader("Content-type", "application/json");
